...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.ipekp7s.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        const informationCollection = client.db('OrganicProduct').collection('information');
...
app.get('/', (req, res) => {
    res.send('Running organic server')
});
